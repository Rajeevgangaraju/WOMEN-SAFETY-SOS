...
public class FireSafetyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firesafety);
        initialization();
    }
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult == null) {
                    Toast.makeText(FireSafetyActivity.this, "Could not get location", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (ContextCompat.checkSelfPermission(FireSafetyActivity.this, Manifest.permission.SEND_SMS)
                    ...
                    ActivityCompat.requestPermissions(FireSafetyActivity.this,
                ...
                .addOnFailureListener(this, e -> {
                    ...
                    if (statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        try {
                            ...
                            resolvable.startResolutionForResult(FireSafetyActivity.this, REQUEST_CHECK_SETTINGS);
                        } catch (IntentSender.SendIntentException sendEx) {
                            Toast.makeText(FireSafetyActivity.this, "Error opening location settings dialog", Toast.LENGTH_SHORT).show();
                        }
                    } else if (statusCode == LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE) {
                        Toast.makeText(FireSafetyActivity.this, "Unable to turn on location. Please enable location in settings.", Toast.LENGTH_LONG).show();
                    }
                });
    }
