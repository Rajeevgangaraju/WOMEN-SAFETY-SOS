        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult == null) {
                    Toast.makeText(AccidentActivity.this, "Could not get location", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (ContextCompat.checkSelfPermission(AccidentActivity.this, Manifest.permission.SEND_SMS)
                    ...
                    ActivityCompat.requestPermissions(AccidentActivity.this,
                ...
                .addOnFailureListener(this, e -> {
                    ...
                    if (statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        try {
                            ...
                            resolvable.startResolutionForResult(AccidentActivity.this, REQUEST_CHECK_SETTINGS);
                        } catch (IntentSender.SendIntentException sendEx) {
                            Toast.makeText(AccidentActivity.this, "Error opening location settings dialog", Toast.LENGTH_SHORT).show();
                        }
                    } else if (statusCode == LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE) {
                        Toast.makeText(AccidentActivity.this, "Unable to turn on location. Please enable location in settings.", Toast.LENGTH_LONG).show();
                    }
                });
    }
