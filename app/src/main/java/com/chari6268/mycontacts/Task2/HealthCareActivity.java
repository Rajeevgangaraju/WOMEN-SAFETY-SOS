...
public class HealthCareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthcare); // Create this layout if needed
        initialization();
    }
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult == null) {
                    Toast.makeText(HealthCareActivity.this, "Could not get location", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (ContextCompat.checkSelfPermission(HealthCareActivity.this, Manifest.permission.SEND_SMS)
                    ...
                    ActivityCompat.requestPermissions(HealthCareActivity.this,
                ...
                .addOnFailureListener(this, e -> {
                    ...
                    if (statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        try {
                            ...
                            resolvable.startResolutionForResult(HealthCareActivity.this, REQUEST_CHECK_SETTINGS);
                        } catch (IntentSender.SendIntentException sendEx) {
                            Toast.makeText(HealthCareActivity.this, "Error opening location settings dialog", Toast.LENGTH_SHORT).show();
                        }
                    } else if (statusCode == LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE) {
                        Toast.makeText(HealthCareActivity.this, "Unable to turn on location. Please enable location in settings.", Toast.LENGTH_LONG).show();
                    }
                });
    }
